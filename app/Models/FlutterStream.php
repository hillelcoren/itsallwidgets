...
class FlutterStream extends Model implements Feedable
{
    ...
    public function toObject()
    {
        ...
        $obj->is_upcoming = ! Carbon::parse($this->starts_at)->addHours(1)->isPast();
        $obj->is_soon = ! $startsAtDate->isPast() && Carbon::parse($this->starts_at)->subHours(1)->isPast();
        $obj->is_live = $startsAtDate->isPast() && ! Carbon::parse($this->starts_at)->addHours(1)->isPast();
        $obj->url = $this->url();
